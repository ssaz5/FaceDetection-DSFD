...
def vis_detections(im,  dets, image_name , thresh=0.5, save_folder='', plot_only = False, ax = None):
...
def flip_batch(dets, img_size=320):
    dets_t = []
    for det in dets:
        det_t = np.zeros(det.shape)
